...
// Функция возвращает true или false в зависимости от того встречается ли элемент первый раз в массиве(true) или
// этот элемент в массиве уже встречался(false).
